...
public class StringUtil {
	...
	public static String getUUID() {
		...
		return str.substring(0,8) + str.substring(9,13) + str.substring(14,18) + str.substring(19,23) + str.substring(24);//去掉"-"符号
	}
	...
	/**
	 * desc:Int——>String 前补零
	 * <p>创建人：王世院, Apr 12, 2013 9:52:14 AM</p>
	 * @param length
	 * @param param
	 * @return
	 */
	 ...
	 * <p>创建人：linfangjian , Sep 23, 2015 4:06:37 PM</p>
	 * @param value 字符串
	 * @param punctuation 截取符号
	 * @param direction 符号前或者符号后 front（前） back（后）
	 * @return characterSegmentation("linfangjian@umpay.com","@","front")
	 * return linfangjian
	 */
	...
	/**
	 * desc:脱敏处理，前6后4
	 * <p>创建人：xuhuanchao , 2016-11-25 下午6:50:57</p>
	 * @param str
	 * @return
	 */
 ...
 * 
 * desc:读取2进制流
 * <p>创建人：zhaohonglin , 2017-4-26 下午5:27:04</p>
 * @param in
 * @return
 */
 ...
 * 
 * desc:字符串转为字节流
 * <p>创建人：zhaohonglin , 2017-4-26 下午5:59:22</p>
 * @param s
 * @return
 */
